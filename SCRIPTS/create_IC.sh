...
#copy namelists
cp $GFILE/STARTFILES/ICS/initcd_votemper_orig.namelist $ICS/initcd_votemper_orig.namelist
cp $GFILE/STARTFILES/ICS/initcd_vosaline_orig.namelist $ICS/initcd_vosaline_orig.namelist
...
#sosie flooding
cp $GFILE/STARTFILES/ICS/job_sosie_orig_CMEMS.sh $ICS/job_sosie_orig_CMEMS.sh
...
#copy the namelists
cp $GFILE/STARTFILES/ICS/namelist_reshape_bilin_initcd_votemper $ICS/.
cp $GFILE/STARTFILES/ICS/namelist_reshape_bilin_initcd_vosaline $ICS/.
...
ln -s $DOMAIN/domain_cfg_ORCA12.nc $ICS/domain_cfg.nc
...
cp $GFILE/STARTFILES/ICS/initcd_votemper.namelist $ICS/initcd_votemper.namelist
cp $GFILE/STARTFILES/ICS/initcd_vosaline.namelist $ICS/initcd_vosaline.namelist
...
cp $GFILE/STARTFILES/ICS/job_sosie_CMEMS.sh $ICS/job_sosie_CMEMS.sh
#ATTENTION modify job for sossie paths etc.
qsub -q serial job_sosie_CMEMS.sh
/home/n01/n01/jenjar93/local/bin/sosie3.x -f initcd_vosaline.namelist
...
ncap2 -O -s 'gdept_3D[z,y,x]=nav_lev' vosaline_CMEMS-GLOBAL_REANALYSIS_PHY-001_030-SANH_2017.nc tmp.nc
ncap2 -O -s 'gdept_4D[time_counter,z,y,x]=gdept_3D' tmp.nc initcd_depth.nc
rm tmp.nc

#create mask that corresponds to the new fields
ncks -d time_counter,0,0,1 -v vosaline vosaline_CMEMS-GLOBAL_REANALYSIS_PHY-001_030-SANH_2017.nc initcd_mask.nc
