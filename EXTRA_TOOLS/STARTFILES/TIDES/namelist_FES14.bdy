...
!  grid information 
!-----------------------------------------------------------------------
   sn_src_hgr = '/projectsa/accord/SANH_jenjar/CMEMS_SANH/CMEMS_subdomain_coordinates.nc'   !  parent /grid/
   sn_src_zgr = './inputs_src_zgr.ncml'   !  parent
   sn_dst_hgr = './domain_cfg.nc'
   sn_dst_zgr = './inputs_dst.ncml' ! rename output variables
   sn_src_msk = '/projectsa/accord/SANH_jenjar/CMEMS_SANH/CMEMS_subdomain_mask.nc'       ! parent
   sn_bathy   = './bathy_meter.nc'        ! child

!-----------------------------------------------------------------------
!  I/O 
!-----------------------------------------------------------------------
   sn_src_dir = 'NCML/CMEMS_1994.ncml' !NCML/ORCA0083_N06_1960.ncml'       ! src_files/'
   sn_dst_dir = 'OUTPUT/TIDES/'
   sn_fn      = 'SANH_CMEMS'                 ! prefix for output files
   nn_fv      = -1e20                     !  set fill value for output files
   nn_src_time_adj = 0					  ! src time adjustment
   sn_dst_metainfo = 'metadata info: annkat'
