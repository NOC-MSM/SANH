...
echo $mon
 for day in $(seq -f "%02g" 1 31)
  do
  echo $day
python -m motuclient --motu https://my.cmems-du.eu/motu-web/Motu --service-id GLOBAL_MULTIYEAR_PHY_001_030-TDS --product-id cmems_mod_glo_phy_my_0.083_P1D-m --longitude-min 50 --longitude-max 115 --latitude-min -10 --latitude-max 30 --date-min "${year}-${mon}-${day} 12:00:00" --date-max "${year}-${mon}-${day} 12:00:00" --depth-min 0.49402499198913574 --depth-max 5727.9169921875 --variable thetao --variable zos --variable so --out-name "CMEMS_${year}-${mon}-${day}_download.nc" --user USERNAME --pwd PASSWORD
done
fi
...
python -m motuclient --motu https://my.cmems-du.eu/motu-web/Motu --service-id GLOBAL_MULTIYEAR_PHY_001_030-TDS --product-id cmems_mod_glo_phy_my_0.083_P1D-m --longitude-min 70 --longitude-max 130 --latitude-min -5 --latitude-max 25 --date-min "1995-01-01 12:00:00" --date-max "1995-01-01 12:00:00" --depth-min 0.49402499198913574 --depth-max 5727.9169921875 --variable so --variable thetao --variable zos --out-name "CMEMS_1995_01_01_download.nc" --user USERNAME --pwd PASSWORD

python -m motuclient --motu https://my.cmems-du.eu/motu-web/Motu --service-id GLOBAL_MULTIYEAR_PHY_001_030-TDS --product-id cmems_mod_glo_phy_my_0.083_P1D-m --longitude-min 50 --longitude-max 115 --latitude-min -10 --latitude-max 30 --date-min "1994-12-31 12:00:00" --date-max "1994-12-31 12:00:00" --depth-min 0.49402499198913574 --depth-max 5727.9169921875 --variable thetao --variable zos --variable so --out-name "CMEMS_1994-12-31_download.nc" --user USERNAME --pwd PASSWORD
